...
def get_fundamentals(ticker: str, curr_date: str | None = None) -> str:
    return unsupported_response(
        ...
        "Futu fundamentals were not validated in the current integration.",
    )
...
def get_balance_sheet(ticker: str, freq: str = "quarterly", curr_date: str | None = None):
    return unsupported_response(
        ...
        "get_balance_sheet",
        detect_market(ticker),
        "Futu balance sheet support was not validated.",
    )
...
def get_income_statement(ticker: str, freq: str = "quarterly", curr_date: str | None = None):
    return unsupported_response(
        ...
        detect_market(ticker),
        "Futu income statement support was not validated.",
    )
